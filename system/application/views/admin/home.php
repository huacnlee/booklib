...
<div id="main">	
	...
	<div id="app-logo">
		<img src="<?=site_url() ?>images/logo.jpg" class="image" alt="BookLibrary" /> 
		<span class="app-name"><span class="book">Book</span>Library</span>
	</div>
	<div id="shortcut" class="box">
		<a href="<?=site_url() ?>admin/books/">View all books</a>
		<a href="<?=site_url() ?>admin/books/create">Create New</a>
	</div>
	<div id="quicksearch" class="box form">
		<?=form_open("admin/books/index")?>
		<input type="text" id="txtSearch" name="searchtext" class="text" /> <button type="submit" onclick="return doSearch();" class="search">Search</button>
		<?=form_close()?>
	</div>
